...
| JSON                                              | JSON is not strictly typed in nature, so we haven't settled on a standard yet. Solutions developed by the community: [json-as](https://github.com/JairusSW/json-as), [assemblyscript-json](https://github.com/nearprotocol/assemblyscript-json)
